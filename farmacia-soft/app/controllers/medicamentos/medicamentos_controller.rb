...
class Medicamentos::MedicamentosController < ApplicationController
  ...
  def medicamento_params
        params.require(:medicamento).permit(:nombre, :descripcion,:fecha_nacimiento,:present_med_id,:cant_comprimido,:cant_st_min,:cant_st_max,:precio_compra,:precio_venta,:modo_aplicacion,:especificacion,:activo)
  end
end
